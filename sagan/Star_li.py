...
def get_star(star_type, velscale):
    ...
    spec = pd.read_csv(f'{package_path}{splitter}data{splitter}{star_list[star_type]}', delim_whitespace=True, comment='#', header=None, names=['lam', 'Flux'])
...
class StarSpectrum(Fittable1DModel):
    ...
    sigma = Parameter(default=200, bounds=(40, 6000))
